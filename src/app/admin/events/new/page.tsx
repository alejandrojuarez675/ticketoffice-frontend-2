...
export default function NewEventPage() {
  ...
  // Estado para la fecha en Date object (no string)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const payload: Omit<EventDetail, 'id'> = {
        ...
        date: eventDate.toISOString(), // Usar eventDate directamente
        image: {
                    ...
                    <DateTimePicker
                      ...
                      slotProps={{
                        textField: {
                          ...
                          margin: 'normal',
                          error: !!errors.date,
                          helperText: errors.date || 'Selecciona fecha y hora. Debe ser al menos mañana.',
                          sx: {
                            '& .MuiInputBase-input': {
                              cursor: 'pointer',
                            },
