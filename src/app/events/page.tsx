...
function EventsListInner() {
  ...
  const filters: Filters = useMemo(
    ...
    [countryParam, city, searchParams, adultOnly, minPrice, maxPrice, vendorsParam]
  );
  ...
  const activeCount = useMemo(() => {
    let n = 0;
    const keys = ['country', 'city', 'category', 'dateFrom', 'dateTo', 'adultOnly', 'minPrice', 'maxPrice', 'vendors', 'q'];
    keys.forEach((k) => {
